import { Image, Text, Switch, TouchableOpacity, View, TextInput, ScrollView } from "react-native";
            ...
            <View className="mt-6 space-y-6">
                <View className="flex-row items-center gap-2">
                    <Switch 
                        ...
                        thumbColor={isPbulic ? "#9b79ea" : "#9e9ea0"}
                    />
            ...
            <View className="flex-row items-center gap-2">
              ...
              <Text className="text-sm font-bold text-gray-200">
                ...
                <TextInput
                    ...
                    className="p-8 font-body text-lg text-gray-50"
